...
const Partners = () => (
    <section>
        <div>
            <h1 style={{fontFamily: 'public sans', textAlign: 'center', color: 'rgb(17, 17, 17)', marginTop: '50px', fontWeight: '500', letterSpacing: '2px', lineHeight: '33px'}} className='lg:text-[28px] text-[20px]'>Trusted by 5,000+ Companies Worldwide</h1>
        </div>
