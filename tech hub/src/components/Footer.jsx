    ...
    <section>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 p-5'>
            <div style={{fontFamily: 'public-sans'}}>
                ...
                <p className='text-[#6D737A] mt-5'>Praesent nulla massa, hendrerit <br className='sm:block hidden'/> vestibulum gravida in, feugiat auctor felis.</p>
            ...
            <div style={{fontFamily: 'public-sans'}}>
              <h1 className='text-[#1E1100] lg:text-[24px] font-[600]'>Subscribe</h1>
              <p className='text-[#6D737A] mt-5'>Lorem Ipsum has been them an industry printer took a galley make book.</p>
              <div>
      ...
      <div className="relative mt-10">
        <input
          ...
          <div className='mt-10'>
          <a href="#" style={{fontFamily: 'poppins', fontSize: '18px', fontWeight: '100', background: '#EEA10D', padding: '10px', borderRadius: '5px'}}>Subscribe Now</a>
        </div>
      </div>
      </div>
      </div>           
