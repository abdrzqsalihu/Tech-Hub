    ...
    <section>
        ...
        <div className='md:p-20 p-'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-center mx-auto mt-16'>
                <img src={hand} alt="" />
                <div>
                    <h1 className='text-[#1E1100] lg:text-[28px] text-[20px] font-semibold md:mt-0 mt-10' style={{fontFamily: 'public sans'}}>Hands-On Learning</h1>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-center mx-auto mt-16'>
                <div className='order-2 md:order-1'>
                    <h1 className='text-[#1E1100] lg:text-[28px] text-[20px] font-semibold md:mt-0 mt-10' style={{fontFamily: 'public sans'}}>Career Support Services</h1>
                    <p className='text-[#1E1100] lg:text-[24px] text-[18px] mt-5' style={{fontFamily:'public sans'}}>We offer comprehensive career support services, <br className='sm:block hidden'/> including resume building, interview preparation, <br className='sm:block hidden'/> job placement assistance, and networking events. </p>
                </div>
