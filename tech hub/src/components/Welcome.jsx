...
const Welcome = () => (
    <section>
        ...
        <div className={`relative text-center lg:text-[40px] text-[25px]`}>
            ...
            <div className='ml-[55%] md:ml-[50%] -mt-1'>
                <img src={curve2} alt=""/>
            </div>
            </h1>
        </div>
        </div>
        <div style={{fontFamily:'public sans', lineHeight: '24px', fontWeight: '400',}} className='lg:text-[20px] text-[17px]'>
